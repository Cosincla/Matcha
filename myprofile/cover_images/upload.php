...
if (isset($_POST["sub_image"]) && !empty($_POST["sub_image"])) {
    ...
    echo '<script type=text/javascript>alert("You must either take a photo or upload an image"); window.location="http://localhost/Matcha/myprofile/cover_images/cover.php";</script>';
?>